...
import RegisterContainer from "./pages/loginsignin/RegisterContainer";
import LoginVendeur from './pages/loginsignin/LoginVendeur';
import ValiderPassword from './pages/loginsignin/ValiderPassword';
import ProductOverviewContainer from './pages/productOverview/ProductOverviewContainer';
// import DashboardContainer from './pages/dashboard/DashboardContainer'
      ...
      <div>
        ...
        <Router ref={registerNav}>
          <Switch>
            ...
            <Route path="/RegisterVendeur" component={LoginVendeur}></Route>
            <Route path="/verify/:token" component={ValiderPassword}></Route>
